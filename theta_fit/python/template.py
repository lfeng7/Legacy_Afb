...
#XBINS = array('d',[-1.00,-0.90,-0.80,-0.70,-0.60,-0.50,-0.40,-0.20,0.20,0.40,0.50,0.60,0.70,0.80,0.90,1.00])
#YBINS = array('d',[0.,0.025,0.05,0.1,0.15,0.2,0.25,0.3,0.7]) # fine binning
#YBINS = array('d',[0.,0.05,0.15,0.3,0.7]) # coarse binning
YBINS = array('d',[0,0.02,0.04,0.08,0.1,0.12,0.14,0.16,0.22,0.26,0.28,0.36,0.42,0.7]) # adaptive
...
ZBINS = array('d',[350.,400,450,500,550,600,650,700,800,1000])
