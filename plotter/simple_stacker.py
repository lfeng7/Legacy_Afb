...
labels = []
labels = label.split(' ')
mc_stack = ROOT.THStack(name+'_stack',title)
for i,ihist in enumerate(hists):
    ...
    print "%s"%all_files[i]
    print 'Entries, Integral : %i, %i'%(ihist.GetEntries(),ihist.Integral())
