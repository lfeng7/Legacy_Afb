...
python selection.py --inputfiles $prepend/T_s-channel_TuneZ2star_8TeV-powheg-tauola_all/\*.root  --maxfiles -1 --maxevts -1 --type T_s_v2 --makeplots no >> logs/singleTop.log
echo processing T_t-channel_TuneZ2star_8TeV-powheg-tauola_all
python selection.py --inputfiles $prepend/T_t-channel_TuneZ2star_8TeV-powheg-tauola_all/\*.root  --maxfiles -1 --maxevts -1 --type T_t_v2 --makeplots no >> logs/singleTop.log
...
python selection.py --inputfiles $prepend/Tbar_t-channel_TuneZ2star_8TeV-powheg-tauola_all/\*.root  --maxfiles -1 --maxevts -1 --type Tbar_t_v2 --makeplots no >> logs/singleTop.log
