...
flist.extend(['T_s_selection_output_all.root',259176,3.79,'singletop',259176,259176] )
flist.extend(['TT_CT10_selection_output_all.root',21560109,245.9,'ttbar',21560109,1150618])
...
for hist in hlist:
    hlist_.extend(ROOT.THStack(hist,'undefined'))
