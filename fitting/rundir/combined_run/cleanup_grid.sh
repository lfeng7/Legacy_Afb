...
#mv aggregated_distributions.root final_fit_stuff
#mv fit_results.txt final_fit_stuff
#mv fit_comparison.pdf final_fit_stuff
mv sideband.pdf final_fit_stuff
mv nominal_1M_output/final_fit_stuff/fit_results.txt fit_results/
mv fit_results.txt fit_results/
